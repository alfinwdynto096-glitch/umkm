...
<head>
    ...
    <meta name="description"
        content="Menu lengkap UMKM Mart: Beranda, Produk, Kategori, Promo, tentang kami, dan cara bergabung sebagai seller.">
    ...
    <style>
        ...
        .btn-umkm-primary:hover {
            color: #fff;
            background: linear-gradient(135deg, #b55e12, #d98322);
        }

        .btn-umkm-outline {
            border: 1px solid rgba(31, 92, 76, .2);
            color: var(--umkm-secondary);
            background: #fff;
        }

        .btn-umkm-outline:hover {
            background: var(--umkm-secondary);
            color: #fff;
            border-color: var(--umkm-secondary);
        }
        ...
        .menu-card:hover {
            ...
            box-shadow: 0 28px 50px rgba(27, 27, 27, .13);
            color: var(--umkm-dark);
        }
        ...
        .icon-orange {
            background: rgba(201, 107, 24, .12);
            color: var(--umkm-primary);
        }

        .icon-green {
            background: rgba(31, 92, 76, .10);
            color: var(--umkm-secondary);
        }

        .icon-yellow {
            background: rgba(246, 196, 83, .25);
            color: #8b5a00;
        }
    ...
    <nav class="navbar navbar-expand-lg fixed-top py-3">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-3 fw-bold" href="{{ url('/beranda') }}">
                ...
                <span>UMKM Mart <small class="d-block fw-normal text-muted" style="font-size:.75rem">Pasar Produk Lokal
                        Nusantara</small></span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav ms-auto mb-3 mb-lg-0 align-items-lg-center gap-lg-2">
                    ...
                    <li class="nav-item"><a class="nav-link fw-semibold" href="{{ url('/beranda') }}#fitur">Fitur</a>
                    </li>
                    <li class="nav-item"><a class="nav-link fw-semibold"
                            href="{{ url('/beranda') }}#testimoni">Testimoni</a></li>
                    <li class="nav-item"><a class="nav-link fw-semibold" href="{{ url('/beranda') }}#kontak">Kontak</a>
                    </li>
                </ul>
        ...
        <div class="container position-relative" style="z-index:1">
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ url('/beranda') }}"
            ...
            <p class="text-white-50 mb-0">Pilih menu yang ingin kamu kunjungi — dari produk, kategori, promo, hingga
                cara bergabung sebagai seller.</p>
        </div>
    </section>
            ...
            <div class="menu-grid">
                ...
                <a href="{{ url('/beranda') }}" class="menu-card" id="menuBeranda">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="small text-muted mb-0">Halaman utama dengan hero, produk unggulan, promo, dan
                            testimoni.</p>
                    </div>
                ...
                <a href="{{ url('/produk') }}" class="menu-card" id="menuProduk">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="small text-muted mb-0">Katalog lengkap 2.500+ produk UMKM dengan filter dan pencarian.
                        </p>
                    </div>
                ...
                <a href="#" class="menu-card" id="menuKategori">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="small text-muted mb-0">Jelajahi produk berdasarkan kategori: makanan, fashion,
                            kerajinan, dll.</p>
                    </div>
                ...
                <a href="#" class="menu-card" id="menuPromo">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="small text-muted mb-0">Kumpulan penawaran flash sale, voucher, dan bundling produk.
                        </p>
                    </div>
                ...
                <a href="#" class="menu-card" id="menuSeller">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="small text-muted mb-0">Daftar seller terpercaya dengan produk lokal berkualitas
                            tinggi.</p>
                    </div>
            ...
            <div class="menu-grid">
                ...
                <a href="#" class="menu-card" id="menuProfil">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="small text-muted mb-0">Lihat dan edit data diri, foto profil, dan alamat pengiriman.
                        </p>
                    </div>
                    <i class="bi bi-arrow-right menu-arrow fs-5"></i>
                </a>
                ...
                <a href="#" class="menu-card" id="menuUlasan">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="small text-muted mb-0">Beri penilaian dan komentar pada produk yang sudah kamu beli.
                        </p>
                    </div>
                    <i class="bi bi-arrow-right menu-arrow fs-5"></i>
                </a>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="quick-card h-100">
                        ...
                        <p class="opacity-75 mb-4">Pasarkan produkmu ke ribuan pembeli. Gratis daftar, mudah kelola,
                            langsung jualan!</p>
                        <a href="#" class="btn btn-light fw-semibold rounded-pill px-4">Mulai Sekarang <i
                ...
                <div class="col-md-6">
                    <div class="quick-card green h-100">
                        ...
                        <p class="opacity-75 mb-4">Tim kami siap membantu kamu 24/7. Chat langsung atau lihat FAQ untuk
                            jawaban cepat.</p>
                        <div class="d-flex flex-wrap gap-2">
                            <a href="#" class="btn btn-light fw-semibold rounded-pill px-4">Live Chat</a>
                            <a href="#" class="btn btn-outline-light fw-semibold rounded-pill px-4">Lihat
                                FAQ</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-4 mb-4">
                <div class="col-lg-4">
                    ...
                    <p class="mb-3">Platform penjualan produk UMKM yang responsif, lengkap, dan siap dikembangkan.
                    </p>
            ...
            <div
                class="border-top border-light border-opacity-10 pt-3 d-flex flex-column flex-md-row justify-content-between gap-2">
