            ...
            <form method="post" action="{{ route('login.post') }}"class="flex flex-col gap-lg">
                ...
                <div class="flex flex-col gap-xs">
                    ...
                    <div class="relative group">
                        ...
                        <input class="w-full pl-12 pr-md py-3 rounded-lg border border-outline-variant focus:border-primary focus:ring-2 focus:ring-primary/20 bg-surface-container-lowest transition-all duration-200 outline-none" id="email" name="email" placeholder="nama@perusahaan.com" required="" type="email"/>
                    </div>
                </div>
                <!-- Password Field -->
                <div class="flex flex-col gap-xs">
                    ...
                    <div class="relative group">
                        ...
                        <input class="w-full pl-12 pr-12 py-3 rounded-lg border border-outline-variant focus:border-primary focus:ring-2 focus:ring-primary/20 bg-surface-container-lowest transition-all duration-200 outline-none" id="password" name="password" placeholder="••••••••" required="" type="password"/>
                ...
                <!-- CTA Button -->
                    <button class="w-full bg-primary text-on-primary font-button py-4 rounded-xl shadow-lg shadow-primary/20 hover:bg-primary-container active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-sm" type="submit">
                    Masuk sebagai Mitra
